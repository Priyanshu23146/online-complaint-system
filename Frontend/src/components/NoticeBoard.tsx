    ...
    <div className="space-y-4">
      ...
      {notices.length === 0 && !error && (
        <div className="bg-slate-50 border border-slate-200 rounded-lg p-8 text-center">
          ...
          <p className="text-slate-500">No notices for you right now.</p>
        </div>
      )}
        ...
        {notices.map((n) => {
          ...
          return (
            ...
            >
              ...
              <p className="text-slate-600 text-sm leading-relaxed whitespace-pre-wrap mb-3">
                {n.content}
              </p>
              ...
              <div className="flex items-center justify-between pt-3 border-t border-slate-100">
                <p className="text-xs text-slate-500">
                  ...
                  <span className="lowercase bg-slate-100 px-2 py-0.5 rounded">
                    {n.createdBy.role}
                  </span>
                  {n.department && (
                    <>
